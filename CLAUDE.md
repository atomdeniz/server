...
| `ekstre` | ekstre | `ekstre.{{ root_host }}` | Static download/landing page for the Ekstre **desktop** app (nginx, serves `roles/ekstre/files/index.html`; repo `atomdeniz/ekstre-desktop`) |
